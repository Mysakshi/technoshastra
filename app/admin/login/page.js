  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        <div className="absolute top-0 right-0 w-125 h-125 bg-blue-600/20 rounded-full mix-blend-screen filter blur-3xl opacity-50 animate-blob"></div>
        <div className="absolute bottom-0 left-0 w-150 h-150 bg-indigo-600/20 rounded-full mix-blend-screen filter blur-3xl opacity-50 animate-blob animation-delay-2000"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-200 h-200 bg-purple-600/10 rounded-full mix-blend-screen filter blur-3xl opacity-50 animate-blob animation-delay-4000"></div>
      </div>
      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center justify-center p-2 bg-white rounded-2xl border border-white/10 mb-6 shadow-2xl overflow-hidden w-16 h-16">
            <img src="/logo1.png" alt="Logo" className="w-full h-full object-contain" />
          </Link>
          <h1 className="text-3xl font-extrabold text-white mb-2">TechnoshastraX</h1>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl border border-white/20 p-8 shadow-2xl overflow-hidden relative">
          ...
          <div className="mt-8 text-center text-sm text-slate-400">
            <p>Protected by TechnoshastraX Security Layer.</p>
          </div>
        </div>
      </motion.div>
    </div>
